...
Проект для выгрузки категорий из MPStats, нормализации данных, парсинга веса/объёма, склейки файлов и классификации товаров по настраиваемым правилам.
...
- `План загрузки` — задачи `marketplace + category + month` со статусами;
