...
MPStats Pipeline — открытый инструмент для команд, которые работают с маркетплейс-данными и хотят превращать сырые выгрузки MPStats в понятный корпоративный датасет.
